...
The **LLM Pre-Processing** group selects Gemini, Atlas Cloud, OpenRouter, LM Studio, or Ollama. It stores provider URLs, model selection, tuning values, prompts, and credentials. These settings support Prep Text; they do not select a TTS engine.

See [LLM Preparation Overview](help:llm-overview).
